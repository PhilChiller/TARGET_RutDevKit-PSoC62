...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_readCmd =
{
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
    .cmdWidth = CY_SMIF_WIDTH_NA,
    /* The width of the address transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_eraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_chipEraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x38U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_readStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t APS6404L_3SQR_ZR_SlaveSlot_0_writeStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x00U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_device_cfg_t deviceCfg_APS6404L_3SQR_ZR_SlaveSlot_0 =
{
    ...
    .readCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_writeDisCmd,
    /* Specifies the Erase command. */
    .eraseCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_eraseCmd,
    /* Specifies the sector size of each erase. */
    .eraseSize = 0x0000400U,
    /* Specifies the Chip Erase command. */
    .chipEraseCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_chipEraseCmd,
    /* Specifies the Program command. */
    .programCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_programCmd,
    /* Specifies the page size for programming. */
    .programSize = 0x0000400U,
    /* Specifies the command to read the QE-containing status register. */
    .readStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_readStsRegQeCmd,
    /* Specifies the command to read the WIP-containing status register. */
    .readStsRegWipCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_readStsRegWipCmd,
    /* Specifies the command to write into the QE-containing status register. */
    .writeStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&APS6404L_3SQR_ZR_SlaveSlot_0_writeStsRegQeCmd,
...
const cy_stc_smif_mem_config_t APS6404L_3SQR_ZR_SlaveSlot_0 =
{
    ...
    .deviceCfg = (cy_stc_smif_mem_device_cfg_t*)&deviceCfg_APS6404L_3SQR_ZR_SlaveSlot_0,
#if (CY_IP_MXSMIF_VERSION >= 3)
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_readCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0xECU,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x06U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x04U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_eraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0xDCU,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_chipEraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x60U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x12U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_readStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x35U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x05U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HL512T_SlaveSlot_1_writeStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x01U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_device_cfg_t deviceCfg_S25HL512T_SlaveSlot_1 =
{
    /* Specifies the number of address bytes used by the memory slave device. */
    ...
    .memSize = 0x04000000U,
    /* Specifies the Read command. */
    .readCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_writeDisCmd,
    /* Specifies the Erase command. */
    .eraseCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_eraseCmd,
    /* Specifies the sector size of each erase. */
    .eraseSize = 0x0040000U,
    /* Specifies the Chip Erase command. */
    .chipEraseCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_chipEraseCmd,
    /* Specifies the Program command. */
    .programCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_programCmd,
    /* Specifies the page size for programming. */
    .programSize = 0x0000100U,
    /* Specifies the command to read the QE-containing status register. */
    .readStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_readStsRegQeCmd,
    /* Specifies the command to read the WIP-containing status register. */
    .readStsRegWipCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_readStsRegWipCmd,
    /* Specifies the command to write into the QE-containing status register. */
    .writeStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&S25HL512T_SlaveSlot_1_writeStsRegQeCmd,
    /* The mask for the status register. */
...
const cy_stc_smif_mem_config_t S25HL512T_SlaveSlot_1 =
{
    /* Determines the slot number where the memory device is placed. */
    ...
    .dualQuadSlots = 0,
    /* The configuration of the device. */
    .deviceCfg = (cy_stc_smif_mem_device_cfg_t*)&deviceCfg_S25HL512T_SlaveSlot_1,
#if (CY_IP_MXSMIF_VERSION >= 3)
    /** Continous transfer merge timeout.
     * After this period the memory device is deselected. A later transfer, even from a
     * continuous address, starts with the overhead phases (command, address, mode, dummy cycles).
